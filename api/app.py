...
async def get_scale_users(request: Request, renpho: RenphoWeight = Depends(get_current_user)):
    try:
        ...
        if renpho.user_id:
            ...
            return APIResponse(
                status="success",
                message="Fetched scale users (account id fallback; list_scale_user was empty).",
                data={"users": fallback},
            )
        ...
        if renpho.user_id:
            ...
            return APIResponse(
                status="success",
                message="Fetched scale users (account id from measurements; list_scale_user was empty).",
                data={"users": fallback},
            )
